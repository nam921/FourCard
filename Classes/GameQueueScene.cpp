...
bool GameQueueScene::init()
{
	...
	LabelTTF* label_menu_dequeue = LabelTTF::create("³ª°¡±â", FourCard::DEFAULT_FONT, 18.0f, menuItem_menu_dequeue->getContentSize(), TextHAlignment::CENTER, TextVAlignment::CENTER);
