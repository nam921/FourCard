...
bool MainContentMainLayer::init()
{
	...
	LabelTTF* label_record_total = LabelTTF::create("1024 Àü", "", 16.0f);
	...
	LabelTTF* label_record_win = LabelTTF::create("300 ½Â", "", 16.0f);
	...
	LabelTTF* label_record_lose = LabelTTF::create("724 ÆÐ", "", 16.0f);
	...
	LabelTTF* label_rate = LabelTTF::create("´ç½ÅÀÇ ½Â·ü 29%", "", 30.0f, Size(visibleSize.width, 44.0f), TextHAlignment::CENTER, TextVAlignment::CENTER);
...
bool MainContentInfoLayer::init()
{
	...
	LabelTTF* label_version_current = LabelTTF::create("ÇöÀç¹öÀü   v.0.1", "", 20.0f, Size(visibleSize.width, 27.0f), TextHAlignment::CENTER);
	...
	LabelTTF* label_version_latest = LabelTTF::create("ÃÖ½Å¹öÀü   v.0.2", "", 20.0f, Size(visibleSize.width, 27.0f), TextHAlignment::CENTER);
